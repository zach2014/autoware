...
public class Modal {
	...
	public boolean showAdvanced() throws NoSuchElementException,
		...
		WebElement icon_plus = modalP.findElement(by_plus_icon);
		icon_plus.click();
		return true;
	}
	...
	public boolean hideAdvanced() throws NoSuchElementException,
		...
		WebElement icon_minus = modalP.findElement(by_icon_minus);
		icon_minus.click();
		return true;
	}
	...
	public boolean refreshData() throws NoSuchElementException {
		...
		WebElement icon_refresh = modalP.findElement(by_refresh_icon);
		icon_refresh.click();
		return true;
	}
	...
	public boolean closeCfgPage() throws NoSuchElementException,
		...
		WebElement btn_close = modalP.findElement(by_btn_close);
		btn_close.click();
		return true;
	}
	...
	public boolean saveChanges() throws NoSuchElementException,
		...
		WebElement btn_save = modalP.findElement(by_btn_save);
		btn_save.click();
		return true;
	}
	...
	public boolean cancelChanges() throws NoSuchElementException,
		...
		WebElement btn_cancel = modalP.findElement(by_btn_cancel);
		btn_cancel.click();
		return true;
	}
	...
	public boolean fadeoutModal() throws NoSuchElementException {
		...
		WebElement icon_remove = modalP.findElement(by_icon_remove);
		icon_remove.click();
		return true;
	}
